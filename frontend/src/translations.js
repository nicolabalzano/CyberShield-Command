  ...
  italiano: {
    ...
    levelMap: {
      ...
      levelInfo: {
        ...
        level5: { name: "Analisi Malware", description: "Identifica e neutralizza le minacce software dannose prima che si diffondano." },
        level6: { name: "Social Engineering", description: "Difenditi dagli attacchi di phishing e social engineering." },
        level7: { name: "Sicurezza Applicazioni Web", description: "Proteggi le applicazioni web dalle vulnerabilità comuni come SQL injection." },
  ...
  english: {
    ...
    levelMap: {
      ...
      levelInfo: {
        ...
        level4: { name: "Intrusion Detection", description: "Detect and respond to unauthorized access attempts in real-time." },
        level5: { name: "Malware Analysis", description: "Identify and neutralize malicious software threats before they spread." },
        level6: { name: "Social Engineering", description: "Defend against phishing and social engineering attacks." },
        level7: { name: "Web Application Security", description: "Secure web applications against common vulnerabilities like SQL injection." },
